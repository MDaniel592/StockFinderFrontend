      ...
      <CustomLayout userData={userData}>
        <div className="flex flex-col gap-4 default-w-space my-2">
          ...
          <p className="text-xs lg:text-sm">
            ...
            en un porcentaje determinado (20%, 30%, 40% y 50% o superior), en comparación con el precio mínimo registrado
...
export async function getStaticProps() {
  ...
  const data = await fetch(process.env.BACKEND_API_URL + "/get_oportunities", options)
    .then(async response => {
