      ...
      <section className="default-w-space text-xs">
        <div className="mx-auto text-justify">
          ...
          <section className="mt-4">
            <p>
              La presente Política de Privacidad establece los términos en que StockFinder usa y protege la información
              que es proporcionada por sus usuarios al momento de utilizar su sitio web. StockFinder está comprometida
          ...
          <section className="mt-4">
            <h2 className="text-xl">Información que es recogida</h2>
            <div className="section-title-separator bg-blue-800 w-8 rounded-full mt-1 mb-4 h-2"></div>
            <p>
          ...
          <section className="mt-4">
            <h2 className="text-xl">Uso de la información recogida</h2>
            <div className="section-title-separator bg-blue-800 w-8 rounded-full mt-1 mb-4 h-2"></div>
            <p>
              ...
              dirección que usted proporcione y podrán ser cancelados en cualquier momento. StockFinder está altamente
              comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más
          ...
          <section className="mt-4">
            ...
            <p>
              ...
              de su ordenador ni de usted, a menos de que usted así lo quiera y la proporcione directamente. Usted puede
          ...
          <section className="mt-4">
            <h2 className="text-xl">Enlaces a Terceros</h2>
            <div className="section-title-separator bg-blue-800 w-8 rounded-full mt-1 mb-4 h-2"></div>
            <p>
              Este sitio web pudiera contener enlaces a otros sitios que pudieran ser de su interés. Una vez que usted
              de click en estos enlaces y abandone nuestra página, ya no tenemos control sobre al sitio al que es
          ...
          <section className="mt-4">
            <h2 className="text-xl">Control de su información personal</h2>
            <div className="section-title-separator bg-blue-800 w-8 rounded-full mt-1 mb-4 h-2"></div>
            <p>
              ...
              momento. StockFinder no venderá, cederá ni distribuirá la información personal que es recopilada sin su
              consentimiento, salvo que sea requerido por un juez con un orden judicial. StockFinder se reserva el
