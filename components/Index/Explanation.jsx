  ...
  return (
    <section className="flex flex-wrap gap-4 sm:justify-left">
      <div className="info mb-4 w-full md:w-8/12 md:mb-auto">
        <h1 className="text-2xl sm:text-4xl font-semibold">Empieza a recibir alertas de tus productos favoritos</h1>
        <p className="my-4 text-base">StockTracker te notificará cuando el producto esté disponible y su precio sea igual o inferior al deseado.</p>
        ...
        <h1 id="INFORMACION" className="text-2xl sm:text-4xl font-semibold mt-4">
          ¿Cómo funciona?
        </h1>
