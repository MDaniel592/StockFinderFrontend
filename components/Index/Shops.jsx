...
const shop_list_2 = ['LDLC', 'Neobyte', 'PcComponentes', 'Speedler', 'Versus Gamers']
    ...
    <section className='bg-zinc-800 rounded-lg my-2 py-2 px-2'>
      ...
      <ul className="flex justify-center py-1">
        {shop_list_1.map(value => {
          return <li className="mx-auto" key={Math.random()}><img src={`/images/logos/shops/${value}.png`} className="h-6 lg:h-10 w-auto rounded-md"></img></li>
        })}
      </ul>
      <ul className="flex justify-center py-1">
