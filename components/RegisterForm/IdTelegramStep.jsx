...
export default function IdTelegramStep({
  handleChange,
  prevStep,
  nextStep,
  values
      ...
      <div className="my-6 mx-12">
        <label>
          <a className="text-sm text-center text-slate-300">
            Inserta tu identificador de Telegram si deseas recibir avisos por
            Telegram. En caso contrario, no introduzcas nada y salta el
            siguiente paso
          </a>
          <input
            type="number"
        ...
        <div className="mt-2 text-center">
          ...
          <div>
            <p className="text-sm text-center">
              Antes de solicitar el código de Telegram, debes haber hablado el
              siguiente bot:
            </p>
            <a
              href="https://t.me/SF_ValidatorBot"
              className="text-blue-500 hover:underline decoration-blue-600"
              target="_blank"
              rel="noreferrer"
            >
              @SF_ValidatorBot
          ...
          <p className="text-sm mt-2 mb-4">
            En otras palabras, debes iniciar el chat para poder recibir el
