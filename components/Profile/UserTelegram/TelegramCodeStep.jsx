...
export default function TelegramCodeStep({ handleChange, prevStep, values }) {
  ...
  async function finishRegister() {
    let rawResponse = await authService.verifyTelegramCode(values);
