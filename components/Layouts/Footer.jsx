...
export default function CustomFooter() {
  let link_class =
    'hover:underline text-left text-blue-500 text-xs sm:text-base'
  return (
    <>
      {/* <Banner></Banner> */}
        ...
        <section className="flex px-4 gap-6 sm:gap-10 justify-center">
          <div className="grid">
            ...
            <div className="pl-1 gap-1 grid justify-start">
              <Link href="/builder" className={link_class}>
                Configurador
              </Link>
              <Link href="/categorias" className={link_class}>
                Componentes
              </Link>
              <br />
            </div>
          ...
          <div className="grid">
            ...
            <div className="pl-1 gap-1 grid justify-start">
              <Link href="/politica-privacidad" className={link_class}>
                Política de Privacidad
              </Link>
              <Link href="/aviso-legal" className={link_class}>
                Aviso Legal
              </Link>
