...
export default function ProductsRows({ data, discount }) {
  ...
  const title = discount.end
    ? `Productos con un descuento entre el ${discount.start}% y ${discount.end}%`
    : `Productos con un descuento superior al ${discount.start}%`
  return (
    <section className="">
            ...
            >
              <div className="w-80 h-24 flex flex-row text-center rounded-md border-2 border-blue-500 p-2">
                ...
                <div className="w-64 grid place-content-evenly">
                  <div>
                    <p className="font-sans antialiased text-xs text-blue-500 font-semibold hover:underline">
                      {row['name']}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    <button className="mx-auto rounded-md bg-blue-500 p-1 text-xxs hover:bg-white hover:text-black font-semibold">
                      Ir al producto
                    </button>
                  </div>
                </div>
